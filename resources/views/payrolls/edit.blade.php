                    ...
                    <form action="{{ route('payrolls.update', $payroll->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <select class="form-control select2 @error('employee_id') is-invalid @enderror" id="employee_id"
                                ...
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}  "
                                        {{ old('employee_id', $payroll->id) == $employee->id ? 'selected' : '' }}>
                                        {{ $employee->fullname }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('salary') is-invalid @enderror"
                                        value="{{ old('salary', $payroll->salary) }}" id="salary" name="salary">
                                </div>
                                @error('salary')
                                    <p class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('bonuses') is-invalid @enderror"
                                        value="{{ old('bonuses', $payroll->bonuses) }}" id="bonuses" name="bonuses">
                                </div>
                                @error('bonuses')
                                    <p class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('deductions') is-invalid @enderror"
                                        value="{{ old('deductions', $payroll->deductions) }}" id="deductions" name="deductions">
                                </div>
                                @error('deductions')
                                    <p class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('net_salary') is-invalid @enderror"
                                        value="{{ old('net_salary', $payroll->net_salary) }}" id="net_salary" name="net_salary" readonly>
                                </div>
                                @error('net_salary')
                                    <p class="text-danger">
                                        {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control date @error('pay_date') is-invalid @enderror"
                                value="{{ old('pay_date', $payroll->pay_date) }}" id="pay_date" name="pay_date">
                        </div>
                        @error('pay_date')
                            <p class="text-danger">
                                {{ $message }}
