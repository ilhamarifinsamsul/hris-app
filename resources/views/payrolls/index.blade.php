        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    @if (session('role') == 'HR')
                        <div class="d-flex">
                            <a href="{{ route('payrolls.create') }}" class="btn btn-primary ms-auto mb-3">Add New
                                Payroll</a>
                        </div>
                    @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('payrolls.show', $payroll->id) }}"
                                            class="btn btn-info btn-sm mb-1"><i class="bi bi-file-earmark-text"></i></a>
                                        @if (session('role') == 'HR')
                                            <a href="{{ route('payrolls.edit', $payroll->id) }}"
                                                class="btn btn-warning btn-sm mb-1"><i class="bi bi-pencil-square"></i></a>
