<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('mazer/dist/assets/compiled/svg/logo.svg') }}" alt="Logo"
                        srcset=""></a>
            </div>
        ...
        <div class="px-3 mt-3">
            <div class="fw-bold text-sm">
                {{ auth()->user()->employee->fullname ?? 'User' }}
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (session('role') == 'HR' || session('role') == 'Employee')
